 ...
 */
namespace Custom\ProductGallery\Block\Adminhtml\Product\Helper\Form;
 ...
 */
class ProductGallery extends \Magento\Framework\View\Element\AbstractBlock
{
    /**
     ...
     * @var string
     */
    protected $htmlId = 'media_productgallery';
     ...
     * @var string
     */
    protected $name = 'product[media_productgallery]';
     ...
     * @var string
     */
    protected $image = 'productgalleryimage';
    ...
    {
        $images = $this->getDataObject()->getData('media_productgallery') ?: null;
        if ($images === null) {
            $images = ((array)$this->dataPersistor->get('catalog_product'))['product']['media_productgallery'] ?? null;
        }
