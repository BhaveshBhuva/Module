...
define([
     ...
     */
    $.widget('mage.productInstalledGallery', {
        options: {
            imageSelector: '[data-role=installed-image]',
            imageElementSelector: '[data-role=installed-image-element]',
            template: '[data-template=image]',
            imageResolutionLabel: '[data-role=installed-resolution]',
            imgTitleSelector: '[data-role=installed-img-title]',
            imageSizeLabel: '[data-role=installed-size]',
            types: null,
            initialized: false
        },
        ...
        _bind: function () {
            this._on({
                 ...
                 */
                'mouseup [data-role=installed-delete-button]': function (event) {
                    var $imageContainer;

                    event.preventDefault();
                    $imageContainer = $(event.currentTarget).closest(this.options.imageSelector);
                    this.element.find('[data-role=installed-dialog]').trigger('close');
        ...
        _updateImagesRoles: function () {
            ...
            $images.forEach(function (img) {
                ...
                $img.find('[data-role=installed-roles-labels] li').each(function (index, elem) {
                    var $elem = $(elem),
        ...
        _updateImageDimesions: function (imgContainer) {
            var $img = imgContainer.find(this.options.imageElementSelector)[0],
                $dimens = imgContainer.find('[data-role=installed-image-dimens]');
    ...
    // Extension for mage.productInstalledGallery - Add advanced settings block
    $.widget('mage.productInstalledGallery', $.mage.productInstalledGallery, {
        options: {
            dialogTemplate: '[data-role=installed-img-dialog-tmpl]',
            dialogContainerTmpl: '[data-role=installed-img-dialog-container-tmpl]'
        },
        ...
        _initDialog: function () {
            ...
            $dialog.on('change', '[data-role="installed-image-description"]', function (e) {
                var target = $(e.target),
        ...
        _notifyType: function (event) {
            var $checkbox = $(event.currentTarget),
                $imageContainer = $checkbox.closest('[data-role=installed-dialog]').data('imageContainer');
    ...
    return $.mage.productInstalledGallery;
});
